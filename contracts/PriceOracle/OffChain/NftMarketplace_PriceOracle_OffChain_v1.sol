...
contract NftMarketplace_PriceOracle_OffChain_v1 is  NftMarketplace_PriceOracle_v0, Ownable {
    ...
    function addWhitelistTokenAndPriceFeed(address token, address tokenPriceFeed) public onlyOwner() {
